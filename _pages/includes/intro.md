I am a Ph.D. student in the [European Laboratory for Learning and Intelligent Systems (ELLIS)](https://ellis.eu), affiliated with the [Multimedia and Human Understanding Group (MHUG)](https://mhug.disi.unitn.it/#/) at the [University of Trento, Italy](https://www.unitn.it/en), and currently visiting the [Max Planck Institute for Intelligent Systems (MPI-IS)](https://is.mpg.de/en) in Tübingen, advised by Prof. [Nicu Sebe](https://scholar.google.com/citations?user=stFCYOAAAAAJ&hl=en) and hosted by Prof. [Bernhard Schölkopf](https://is.mpg.de/~bs).
