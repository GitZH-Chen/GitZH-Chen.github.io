I am a Ph.D. student affiliated with [Multimedia and Human Understanding Group (MHUG)](https://mhug.disi.unitn.it/#/) at [University of Trento, Italy](https://www.unitn.it/en), advised by Prof. [Nicu Sebe](https://scholar.google.com/citations?user=stFCYOAAAAAJ&hl=en), and currently visiting the [Max Planck Institute for Intelligent Systems (MPI-IS)](https://is.mpg.de/en), hosted by Prof. [Bernhard Schölkopf](https://is.mpg.de/~bs).
